...
- effd05d: Open Session으로 패키지와 뷰어를 리브랜딩했습니다. 브라우저 오류 직전의 클릭, 키 입력 여부, 화면 이동, 네트워크 상태, 콘솔 로그, 오류 메타데이터를 암호화된 `osr1:` payload로 만들고 Viewer에서 열 수 있습니다.
...
- Updated dependencies [effd05d]
  - @open-session/protocol@0.2.0
